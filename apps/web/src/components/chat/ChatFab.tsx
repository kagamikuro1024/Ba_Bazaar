    ...
    <>
      ...
      >
        {!open ? (
          <span
            aria-hidden="true"
            className="pointer-events-none absolute -left-2 -top-2 h-7 w-7 rounded-full bg-pink-400/70 blur-md"
          />
        ) : null}
        {!open ? (
          <span
            aria-hidden="true"
            className="pointer-events-none absolute inset-y-1 left-[-42%] w-[44%] rounded-full bg-[linear-gradient(90deg,transparent_0%,rgba(255,255,255,0.16)_24%,rgba(255,255,255,0.8)_50%,rgba(255,255,255,0.16)_76%,transparent_100%)] blur-sm mix-blend-screen animate-[chatfab-shimmer_3.6s_ease-in-out_infinite]"
          />
        ) : null}
